...
class ClanRolePermission(Base):
    ...
    can_accept_applications: Mapped[bool] = mapped_column(Boolean, default=False)
    can_reject_applications: Mapped[bool] = mapped_column(Boolean, default=False)
    can_promote: Mapped[bool] = mapped_column(Boolean, default=False)
    can_demote: Mapped[bool] = mapped_column(Boolean, default=False)
    can_edit_clan_description: Mapped[bool] = mapped_column(Boolean, default=False)
    can_edit_clan_banner: Mapped[bool] = mapped_column(Boolean, default=False)
    can_edit_clan_icon: Mapped[bool] = mapped_column(Boolean, default=False)
    can_edit_clan_name: Mapped[bool] = mapped_column(Boolean, default=False)
    ...
    can_manage_bank: Mapped[bool] = mapped_column(Boolean, default=False)
    can_deposit_coins: Mapped[bool] = mapped_column(Boolean, default=True)
    can_withdraw_coins: Mapped[bool] = mapped_column(Boolean, default=False)
    can_start_clan_war: Mapped[bool] = mapped_column(Boolean, default=False)
    can_declare_alliance: Mapped[bool] = mapped_column(Boolean, default=False)
    can_manage_diplomacy: Mapped[bool] = mapped_column(Boolean, default=False)
    can_create_events: Mapped[bool] = mapped_column(Boolean, default=False)
    can_manage_quests: Mapped[bool] = mapped_column(Boolean, default=False)
    can_ping_clan: Mapped[bool] = mapped_column(Boolean, default=False)
    can_view_logs: Mapped[bool] = mapped_column(Boolean, default=False)
    can_transfer_leadership: Mapped[bool] = mapped_column(Boolean, default=False)
    can_delete_clan: Mapped[bool] = mapped_column(Boolean, default=False)
